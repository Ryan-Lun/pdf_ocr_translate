...
def test_api_route_split_preserves_existing_urls_and_endpoint_names(app):
    expected = {
        ...
        ("api.glossary_libraries_create", "/api/glossary/libraries", "POST"),
        ("api.glossary_libraries_update", "/api/glossary/libraries/<int:library_id>", "PATCH"),
        ("api.glossary_libraries_disable", "/api/glossary/libraries/<int:library_id>/disable", "POST"),
        ("api.glossary_libraries_activate", "/api/glossary/libraries/<int:library_id>/activate", "POST"),
        ("api.glossary_library_entries_upsert", "/api/glossary/libraries/<int:library_id>/entries", "POST"),
        ("api.glossary_library_entries_update", "/api/glossary/libraries/<int:library_id>/entries/<int:entry_id>", "PATCH"),
        ("api.glossary_library_entries_disable", "/api/glossary/libraries/<int:library_id>/entries/<int:entry_id>/disable", "POST"),
        ("api.glossary_export_json", "/api/glossary/export-json", "GET"),
        ("api.glossary_import_json", "/api/glossary/import-json", "POST"),
