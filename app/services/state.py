...
APP_LOG_MAX_MB = int(os.getenv("APP_LOG_MAX_MB", "10"))
...
TRANSLATION_MEMORY_ENABLED = _env_bool(
    "TRANSLATION_MEMORY_ENABLED",
    False,
)
TRANSLATION_MEMORY_FUZZY_THRESHOLD = float(os.getenv("TRANSLATION_MEMORY_FUZZY_THRESHOLD", "0.85"))
TRANSLATION_MEMORY_FUZZY_LIMIT = max(0, int(os.getenv("TRANSLATION_MEMORY_FUZZY_LIMIT", "3")))
TRANSLATION_MEMORY_MIN_FUZZY_CHARS = max(0, int(os.getenv("TRANSLATION_MEMORY_MIN_FUZZY_CHARS", "8")))
