...
NGINX_SITE_NAME="uo_regulations_translate"
...
export APP_ROOT NGINX_TEMPLATE OUTPUT_FILE NGINX_LISTEN_PORT
...
content = content.replace("{{NGINX_LISTEN_PORT}}", os.environ["NGINX_LISTEN_PORT"])
